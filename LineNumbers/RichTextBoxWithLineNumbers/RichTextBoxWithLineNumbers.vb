...
Public Class RichTextBoxWithLineNumbers : Inherits System.Windows.Forms.Control
    ...
    Delegate Function SetLineTextDelegate(ByVal lineno As Integer) As LineDrawArgs
    Public LineTextSetter As SetLineTextDelegate = Nothing
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        If zLNIs.Count > 0 Then
            ...
            For zA As Integer = 0 To zLNIs.Count - 1
                ...
                If LineTextSetter <> Nothing Then

                    Using br = New SolidBrush(LineTextSetter(zLNIs(zA).LineNumber).BackColor)
                        e.Graphics.FillRectangle(br, zLNIs(zA).Rectangle)
                    End Using
                ...
                If zLineNumbers_Show = True Then
                    ...
                    If LineTextSetter = Nothing Then
                        ...
                        End If
                    Else
                        zTextToShow = LineTextSetter(zLNIs(zA).LineNumber).Text
                    End If
                    ...
                    If LineTextSetter <> Nothing Then
                        Using br = New SolidBrush(LineTextSetter(zLNIs(zA).LineNumber).ForeColor)
                            e.Graphics.DrawString(zTextToShow, Me.Font, br, zPoint, zSF)
                        End Using
