...
Namespace RichTextBoxWithLineNumbers
    ...
    Public Class RichTextBoxWithLineNumbers : Inherits System.Windows.Forms.Control
        ...
        Delegate Function SetLineTextDelegate(ByVal lineno As Integer) As String
                ...
                For zA As Integer = 0 To zLNIs.Count - 1
                    ...
                    If zLineNumbers_Show = True Then
                        ...
                        If LineTextSetter = Nothing Then
                            ...
                            End If
                        Else
                            zTextToShow = LineTextSetter(zLNIs(zA).LineNumber)
                        End If
