Imports RichTextBoxWithLineNumbers
...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.LineNumbers_For_RichTextBox1 = New RichTextBoxWithLineNumbers.RichTextBoxWithLineNumbers()
        Me.SuspendLayout()
        '
        'RichTextBox1
        '
        ...
        Me.LineNumbers_For_RichTextBox1.DockSide = RichTextBoxWithLineNumbers.RichTextBoxWithLineNumbers.LineNumberDockSide.Left
        ...
        Me.LineNumbers_For_RichTextBox1.MarginLines_Side = RichTextBoxWithLineNumbers.RichTextBoxWithLineNumbers.LineNumberDockSide.Right
        ...
        Me.LineNumbers_For_RichTextBox1.LineTextSetter = New RichTextBoxWithLineNumbers.RichTextBoxWithLineNumbers.SetLineTextDelegate(AddressOf doLineSet)
        '
        'Form1
        '
    ...
    Function doLineSet(ByVal lineno As Integer) As String
        Return lineno.ToString() + " B)"
    End Function

    Friend WithEvents LineNumbers_For_RichTextBox1 As RichTextBoxWithLineNumbers.RichTextBoxWithLineNumbers
